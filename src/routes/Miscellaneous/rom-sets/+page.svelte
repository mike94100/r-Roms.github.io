<script lang="ts">
    ...
    const link: Link[] = [
        { name: "No-Intro - ROM Sets", url: "https://archive.org/download/ni-roms/roms/" },
        ...
        { name: "[TOSEC-ISO] Nintendo", url: "https://archive.org/download/tosec-iso-nintendo_" },
        ...
        { name: "Super Mario World Hacks", url: "https://archive.org/download/super-mario-world-hacks" },
...
<div class="mx-8 mb-8 mt-8 space-y-4 bg-background">
    ...
    <p class="leading-7 [&:not(:first-child)]:mt-6">
        ROM sets are large, sorted, verified collections of ROMs, typically
        provided as a single archive file that you will need to extract prior
        to use. The ROM sets here are provided in no particular order.
    </p>
